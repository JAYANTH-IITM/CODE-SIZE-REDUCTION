...
#define TEST_PUSH(rd, testreg, index, rs1, rs1_val, offset, inst,imm_val) ;\
sw rd,0(sp)                                                      ;\
sw rs1,offset(sp)            /* Store rs1 onto the stack with an offset */ ;\
addi sp, sp, -rs1_val          /* Adjust the stack pointer to allocate space for the stack frame */ ;\

#define TEST_POP(rd, testreg, index, rs1, rs1_val, offset, inst,imm_val) ;\
sw rd,0(sp)                                                      ;\
sw rs1,offset(sp)            /* Store rs1 onto the stack with an offset */ ;\
addi sp, sp, -rs1_val          /* Adjust the stack pointer to allocate space for the stack frame */ ;\

#define TEST_POPRET(rd, testreg, index, rs1, rs1_val, offset, inst,imm_val) ;\
sw rd,0(sp)                                                      ;\
sw rs1,offset(sp)            /* Store rs1 onto the stack with an offset */ ;\
addi sp, sp, -rs1_val          /* Adjust the stack pointer to allocate space for the stack frame */ ;\

#define TEST_POPRETZ(rd, testreg, index, rs1, rs1_val, offset, inst,imm_val) ;\
sw rd,0(sp)                                                      ;\
sw rs1,offset(sp)            /* Store rs1 onto the stack with an offset */ ;\
addi sp, sp, -rs1_val          /* Adjust the stack pointer to allocate space for the stack frame */ ;\
